...
def main_page():
    ...
    if run:
        ...
        for gen_idx in range(generations):
            # 🔹 Ton algo génétique
            if elitism:
                selected = select_with_elite(population=population,translated_stat=translated_stat,duration_min=duration_min,min_max_or_mean = min_max_or_mean, req_stats=st.session_state.req_stats,method=method,n_select=n_select)
            else:    
