...
def tournament_selection(population, n_select, tournament_selection_rounds,translated_stat,duration_min,min_max_or_mean,req_stats):
    selected = []
...
def boltzmann_selection(population, n_select, boltzmann_selection_temperature, translated_stat, duration_min, min_max_or_mean, req_stats):
    fitnesses = [
...
# CROSSOVER
# ======================
def crossover(parent1, parent2,data, crossover_ingredients,item, lvl_max, raw_recipe, ingredient_quality_coefficient):
