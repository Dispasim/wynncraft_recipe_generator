...
from utils import remove_ingredients_not_in_level_range,remove_blacklisted_ingredients,sort_ingredients,import_recipe_df,calculate_ingredient_quality_bonus,translate_stat
...
if __name__ == "__main__":
    ...
    print(f"Hash : {best_solution[0].encode_craft(CRAFTER_ENC,FIRST_INGREDIENT_QUALITY,SECOND_INGREDIENT_QUALITY).to_string_r()}")
