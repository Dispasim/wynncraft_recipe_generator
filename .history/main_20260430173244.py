...
import json
import numpy as np
from individual import Individual,remove_ingredients_not_in_level_range,remove_blacklisted_ingredients
...
LEVEL_MIN = 0
LEVEL_MAX = 103
FOCUSED_STAT = "lootBonus"
INGREDIENT_BLACKLIST = ["Aspect of the Void"]
BASE_DURATION = 972
JOB = "woodworking"

with open(f"resultat_{JOB}.json", "r", encoding="utf-8") as f:
    data = json.load(f)
