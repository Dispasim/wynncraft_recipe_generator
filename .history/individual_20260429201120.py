...
class Individual:
    ...
    def diplay_recipe(self):
        ...
        print("===============================\n")
        print(f"|   {self.recipe[0,0]:10}   |    {self.recipe[0,1]:10}  |   {self.recipe[0,2]:10}   |\n")
        print("===============================\n")
        print(f"|   {self.recipe[1,0]:10}   |    {self.recipe[1,1]:10}  |   {self.recipe[0,2]:10}   |\n")
        print("===============================\n")
        print(f"|   {self.recipe[2,0]:10}   |    {self.recipe[2,1]:10}  |   {self.recipe[2,2]:10}   |\n")
        print("===============================\n")