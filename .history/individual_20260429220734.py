...
def remove_ingredients_not_in_level_range(ingredients,lvl_min,lvl_max):
    for ing in ingredients:
        if (ing["requirements"]["level"] < lvl_min) or (ing["requirements"]["level"] > lvl_max):
...
class Individual:
    def __init__(self,data,base_duration = 1000,chosen_ingredients = None,lvl_min = 0,lvl_max = 120):
        ...
        chosen_ingredients = remove_ingredients_not_in_level_range(chosen_ingredients,lvl_min,lvl_max)
