...
class individual:
    ...
    def display_recipe(self):
        print(f"durection : {self.duration}")
        print("===============================\n")
        print(f"|   {self.recipe[0,0]["displayName"]:10}   |    {self.recipe[0,1]["displayName"]:10}  |   {self.recipe[0,2]["displayName"]:10}   |\n")
        print("===============================\n")
        print(f"|   {self.recipe[1,0]["displayName"]:10}   |    {self.recipe[1,1]["displayName"]:10}  |   {self.recipe[1,2]["displayName"]:10}   |\n")
        print("===============================\n")
        print(f"|   {self.recipe[2,0]["displayName"]:10}   |    {self.recipe[2,1]["displayName"]:10}  |   {self.recipe[2,2]["displayName"]:10}   |\n")
        print("===============================\n")