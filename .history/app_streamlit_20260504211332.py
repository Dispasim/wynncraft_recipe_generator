...
def test_page():
    ...
    if st.button("generate"):
        ...
        st.write("Best fitness:", ind.fitness(stat=translated_stat,duration_min=duration_min,min_max_or_mean=st.session_state.min_max_or_mean,req_stats=list(req_values.values())))
