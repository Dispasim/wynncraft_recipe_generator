...
INGREDIENT_BLACKLIST = ["Altitude Shard","Unsettling Soul"]
ITEM = "scroll"
...
def greedy_search(data):
    best_total  = (None,0)
    for ing1 in tqdm(data):
        for ing2 in data:
            for ing3 in data:
                for ing4 in data:
                    for ing5 in data:
                        for ing6 in data:
                            ind = Individual(data,chosen_ingredient = [ing1,ing2,ing3,ing4,ing5,ing6],item=ITEM,lvl_max=LEVEL_MAX,recipes_df=raw_recipes,ingredient_quality_coefficient=coef)
...
if __name__ == "__main__":
    ...
    best_solution = greedy_search(data)
