...
class Individual:
    def __init__(self,data,recipes_df,item="scroll",chosen_ingredients = None,lvl_max = 120,ingredient_quality_coefficient = 1,weights = None):
    ...
    def multi_fitness(self, stats, weights=self.weights, duration_min=100, req_stats=[200,200,200,200,200]):
