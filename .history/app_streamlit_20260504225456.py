...
from utils import remove_ingredients_not_in_level_range,remove_blacklisted_ingredients,sort_ingredients,import_recipe_df,calculate_ingredient_quality_bonus,remove_useless_ingredients,give_ingredients_list,get_ingredient_from_string, update_best_archive
import json
import random
import copy
...
def main_page():
    ...
    if run:
        ...
        for gen_idx in range(generations):
            ...
            best_archive = update_best_archive(
                best_archive,
                population,
