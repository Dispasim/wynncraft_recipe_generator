...
from utils import remove_ingredients_not_in_level_range,remove_blacklisted_ingredients,sort_ingredients,import_recipe_df
...
def create_population():
    return [Individual(data=data,item=ITEM,lvl_max=LEVEL_MAX,recipes_df=raw_recipes) for _ in range(POP_SIZE)]
...
def crossover(parent1, parent2):
    ...
    child = Individual(data,chosen_ingredients=crossover_ingredients,item=ITEM,lvl_max=LEVEL_MAX,recipes_df=raw_recipes)
    return child
