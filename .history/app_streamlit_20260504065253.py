...
def main_page():
    ...
    if run:
        ...
        ingredient_quality_coefficient = calculate_ingredient_quality_bonus(quality_one,quality_two)    
        ...
        for gen_idx in range(generations):
            # 🔹 Ton algo génétique
            selected = select(population=population,translated_stat=translated_stat,duration_min=duration_min,mean_max_or_mean = mean_max_or_mean, req_stats=req_values.values(),method=method,)
